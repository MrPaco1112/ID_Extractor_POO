...
import java.awt.*;
import javax.swing.*;
public class ActualizInfo extends javax.swing.JFrame {

    String idIngresado;
    String empresaIngresada;
    String nombreNuevo;
    String fechaDeNacimientoNueva;
    String cedulaNueva;
    String correoNuevo;
    String direccionNueva;
    String empresa;
    String clave;
    Persona nuevoValor = new Persona();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Cambie los datos que desea actualizar:");

        jLabel10.setText("ACTUALIZAR INFORMACION EMPLEADOS");
        ...
        jLabel11.setText("EMPRESA DEL EMPLEADO");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        System.out.println("========================");
        System.out.println("Dato: " + nombreNuevo);
        System.out.println("Dato: " + clave);
        System.out.println("Dato: " + nuevoValor);
        System.out.println("Dato: " + cedulaNueva);
        System.out.println("Dato: " + correoNuevo);
        System.out.println("Dato: " + direccionNueva);
        System.out.println("Dato: " + empresa);
        AsistenteFirebase.actualizarInfo(manager.firebaseDatabase, empresa, clave, nuevoValor);
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        idIngresado = jTextField1.getText().trim();
        clave = idIngresado;
        System.out.println("Dato: " + clave);
    }//GEN-LAST:event_jTextField1ActionPerformed

    private void jTextField2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField2ActionPerformed
        nombreNuevo = jTextField2.getText().trim();
        nuevoValor.setNombre(nombreNuevo);
        System.out.println("Dato: " + nombreNuevo);
    }//GEN-LAST:event_jTextField2ActionPerformed

    private void jTextField3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField3ActionPerformed
        fechaDeNacimientoNueva = jTextField3.getText().trim();
        nuevoValor.setEdad(fechaDeNacimientoNueva);
        System.out.println("Dato: " + nuevoValor);
    }//GEN-LAST:event_jTextField3ActionPerformed

    private void jTextField4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField4ActionPerformed
        cedulaNueva = jTextField4.getText().trim();
        nuevoValor.setId(cedulaNueva);
        System.out.println("Dato: " + cedulaNueva);
    }//GEN-LAST:event_jTextField4ActionPerformed

    private void jTextField5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField5ActionPerformed
        correoNuevo = jTextField5.getText().trim();
        nuevoValor.setCorreo(correoNuevo);
        System.out.println("Dato: " + correoNuevo);
    }//GEN-LAST:event_jTextField5ActionPerformed

    private void jTextField6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField6ActionPerformed
        direccionNueva = jTextField6.getText().trim();
        nuevoValor.setDireccion(direccionNueva);
        System.out.println("Dato: " + direccionNueva);
    ...
    private void jTextField7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField7ActionPerformed
        empresaIngresada = jTextField7.getText().trim();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActualizInfo().setVisible(true);
            }
        });
    }
