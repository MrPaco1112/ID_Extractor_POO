...
import java.awt.*;
import javax.swing.*;
public class AgregarManual extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("AGREGUE DE FORMA MANUAL LA INFORMACION");

        jLabel11.setText("AÑADIR INFORMACION DE EMPLEADOS");
    ...
    private void jTextField3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField3ActionPerformed
        fechaDeNacimiento = jTextField3.getText().trim();
        nuevoEmpleado.setEdad(fechaDeNacimiento);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        AsistenteFirebase.agregarInfo(manager.firebaseDatabase, empresa, clave, nuevoEmpleado);
        JOptionPane.showMessageDialog(null, "¡Guardado exitoso!", "Éxito", JOptionPane.INFORMATION_MESSAGE);
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jTextField7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField7ActionPerformed
        empresaEmpleado = jTextField7.getText().trim();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarManual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarManual().setVisible(true);
            }
        });
    }
