...
public class Borrar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ingrese el ID del empleado a eliminar (sin '.') :");
        ...
        jLabel4.setText("Ingrese la empresa del empleado a eliminar :");
    ...
    private void jTextField2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField2ActionPerformed
        empresa = jTextField2.getText().trim();
    }//GEN-LAST:event_jTextField2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        
        int confirmacion = JOptionPane.showConfirmDialog(null, "¿Seguro que quieres eliminar al empleado?", "Confirmar", JOptionPane.YES_NO_OPTION);
            if (confirmacion == JOptionPane.YES_OPTION) {
                AsistenteFirebase.borrarInfo(manager.firebaseDatabase, empresa, id);
