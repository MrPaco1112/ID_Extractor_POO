...
public class IdManager {
    ...
    public void initRTD(){ 
        ...
        //D:D:\Monica Sarmiento\Documents\NetBeansProjects\IdManagerV2\IdManagerV2main\IdManager\pacopruebas-165de-firebase-adminsdk-fbsvc-6eb7c97568.json Ruta en Pacoportatil
        try {
            // Ruta al archivo JSON de credenciales
            String pathToServiceAccount = "D:\\Monica Sarmiento\\Documents\\NetBeansProjects\\IdManagerV2\\IdManagerV2main\\IdManager\\pacopruebas-165de-firebase-adminsdk-fbsvc-6eb7c97568.json";
                ...
                case 1:
                    ...
                    switch(opcion2){
                        ...
                        case 2:
                            ...
                            clave = "/";
                            AsistenteFirebase.leerInfo(manager.firebaseDatabase, nodo);
                            break;
                        case 3:
                            try{
                                s.nextLine();//Limpia buffer para que lea bien
                        ...
                        case 4:
                            ...
                            clave = s.nextLine();
                            AsistenteFirebase.borrarInfo(manager.firebaseDatabase,nodo,clave );
                            break;
                        case 5:
